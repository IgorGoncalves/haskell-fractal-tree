...
/* package t-fractal-0.1.0.0 */
#define VERSION_t_fractal "0.1.0.0"
#define MIN_VERSION_t_fractal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "t-fractal-0.1.0.0"

#define CURRENT_PACKAGE_KEY "t-fractal-0.1.0.0"
