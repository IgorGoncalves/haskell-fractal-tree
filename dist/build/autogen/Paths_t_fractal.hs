...
getLibDir = catchIO (getEnv "t_fractal_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "t_fractal_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "t_fractal_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "t_fractal_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "t_fractal_sysconfdir") (\_ -> return sysconfdir)
